var DATA = {
  'ArrowLeft': {color: '#D686B8', paths: ['btn-left'], audio: 'c', clicked: false},
  'ArrowUp': {color: '#8485C0', paths: ['btn-up'], audio: 'd', clicked: false},
  'ArrowRight': {color: '#93D9F6', paths: ['btn-right'], audio: 'e', clicked: false},
  'ArrowDown': {color: '#9DCE76', paths: ['btn-down'], audio: 'f', clicked: false},
  'Space': {color: '#FDF280', paths: ['btn-space'], audio: 'g', clicked: false},
  'Click': {color: '#FAB06C', paths: ['btn-click'], audio: 'a', clicked: false},
}
